...
import * as strings from 'SpaFormWebPartStrings';
import SpaForm from './components/SpaForm';
import { ISpaFormProps } from './components/ISpaFormProps';

export interface ISpaFormWebPartProps {
  description: string;
   context:any;
  listName:any;
  cancelPageUrl:any;
...
export default class SpaFormWebPart extends BaseClientSideWebPart<ISpaFormWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISpaFormProps> = React.createElement(
      SpaForm,
      {
